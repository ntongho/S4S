...
public class SaveDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.savefile_dialog,null);
        ...
        editText_filename= view.findViewById(R.id.filename);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
           ...
           throw  new ClassCastException(context.toString()+"must implement savedialog listener ");
        }
    }
